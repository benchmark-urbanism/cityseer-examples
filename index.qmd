...
See the [Network Centrality](./recipes/centrality/index.qmd) page for examples of how to calculate a variety of shortest "metric" and simplest "angular" centrality metrics.

#### Accessibility

See the [Accessibility](./recipes/accessibility/index.qmd) page for examples of how to calculate a variety of landuse accessibility and mixed-use metrics.

#### Statistics

See the [Statistics](./recipes/stats/index.qmd) page for examples of how to calculate statistical metrics over the network.
