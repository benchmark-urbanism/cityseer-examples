...
[![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/benchmark-urbanism/cityseer-examples/blob/gh-pages/class/2_basics.ipynb)

::: {.callout-note}

## Learning Objectives

- Assign and use variables with different data types (strings, integers, floats, booleans)
- Work with Python collections: lists, dictionaries, tuples, and sets
- Control program flow with conditionals (`if`/`elif`/`else`) and loops (`for`/`while`)
- Define and call functions with parameters and return values
- Import and use external modules

:::

Python is a versatile language, widely used for urban analysis and data science. This page introduces its foundational concepts: variables, data types, collections, control flow, functions, and modules.
...
Next: [Spatial Data](3_spatial.qmd) introduces geometric objects with Shapely.
