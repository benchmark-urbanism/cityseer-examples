...
[![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/benchmark-urbanism/cityseer-examples/blob/gh-pages/class/3_spatial.ipynb)

::: {.callout-note}

## Learning Objectives

- Create point, line, and polygon geometries with Shapely
- Access geometry properties such as area, length, and centroid
- Test spatial relationships using predicates like `within`, `intersects`, and `touches`
- Perform geometric operations including buffering, union, and difference
...
- Shapely uses Cartesian coordinates — ensure your geometries share the same projected coordinate system for accurate results.
- These building blocks underpin GeoPandas, which extends them to work with collections of features.

Next: [GeoPandas](4_geopandas.qmd) shows how to manage and analyse many spatial features at once.
