...
::: {.callout-tip}
New to `geopandas` or coordinate reference systems? See the [GeoPandas chapter](../../class/4_geopandas.qmd) of the Python 101 section for background. For definitions of terms like "primal graph" and "dual graph", see the [Glossary](../../glossary.qmd).
:::
